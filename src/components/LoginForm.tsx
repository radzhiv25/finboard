...
export function LoginForm({ onSwitchToSignup, className }: LoginFormProps) {
    ...
    const handleOAuthLogin = async (provider: OAuthProvider) => {
        try {
            ...
            alert(error.message || 'OAuth login failed. Please try again.');
            setIsLoading(false);
        }
    };
                    ...
                    <div className="bg-muted relative hidden md:block">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center space-y-4">
                                ...
                                <h3 className="text-2xl font-bold">Welcome to FinBoard</h3>
                                <p className="text-muted-foreground max-w-sm">
                                    Take control of your financial future with our comprehensive dashboard
                                </p>
                            </div>
                        </div>
                    </div>
